...
string items[] = {"Вывести матрицу на экран", "Заполнить матрицу (спираль)", "Заполнить матрицу (змейка)", "Перестановка по квадрату", "Перестановка по кресту", "Перестановка по вертикальным паралельным","Перестановка по горизонтальным паралельным", "Отсортировать", "Уменьшить, увеличить, умножить или поделить", "IDZ #17", "Выход"};
